...
public class Ayuda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\t\tSistema de Gestión de Alumnos\n\n Este programa cuenta con cuatro opciones principales:\n \n Registrar alumnos: \n\t Esta opción sirve para realizar el registro\n\tde alumnos nuevos a la institución. Se deberán \n\tllenar una serie de campos, aunque se pueden\n\tdejar vacíos, a excepción del dni del alumno.\n\t También crea una ficha de inscripción en formato\n\tpdf que se podrá utilizar para imprimir y firmar.\n\n Gestionar alumnos:\n\t Esta opción sirve para modificar datos de\n\talumnos incriptos anteriormente. Se debe elegir\t\n\tal alumno de una tabla dada, y no se podrá modificar\n\tel dni del alumno. A diferencia de la opción anterior,\n\testa funcionalidad cuenta con la opción de modificar una\n\tfecha de inscripción.\n\n Listar alumnos:\n\t Esta opción permite realizar un filtro en el\n\tlistado de alumnos por curso y por nivel. Además permite \n\tguardar en un archivo excel el listado de todos\n\tlos alumnos y familiares. También se podrá eliminar\n\tun alumno y sus datos respectivos. Por último cuenta con\n\tuna pestaña de estadística de datos de los alumnos.\n\n Gestionar cursos:\n\t Permite crear niveles (formas de dividir los grupos en\n\tCuatro Vientos), como así también eliminarlos y \n\tasignarlos, tanto por curso como individualmente.\n\n Programa elaborado por Marcos Godoy Quattoni, alumno de 6to Informática\n del Instituto Politécnico Superior como parte de las Prácticas.\n Año: 2021");
        jTextArea1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 450, 350));
